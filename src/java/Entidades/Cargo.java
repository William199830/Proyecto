...
@NamedQueries({
    ...
    , @NamedQuery(name = "Cargo.findByEMPLEADOidEmpleado", query = "SELECT c FROM Cargo c WHERE c.eMPLEADOidEmpleado = :eMPLEADOidEmpleado")})
public class Cargo implements Serializable {
    ...
    public Cargo(Integer idCargo, String cargo, int eMPLEADOidEmpleado) {
        this.idCargo = idCargo;
        this.cargo = cargo;
